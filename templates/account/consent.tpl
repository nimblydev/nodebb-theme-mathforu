			...
			<div class="panel panel-default">
				<div class="panel-body">
					...
					<div class="btn-group-vertical btn-block">
						<a rel="nofollow" class="btn btn-default" href="{config.relative_path}/api/user/uid/{userslug}/export/profile">
							<i class="fa fa-download"></i> [[user:consent.export_profile]]
						</a>
						<a rel="nofollow" class="btn btn-default" href="{config.relative_path}/api/user/uid/{userslug}/export/posts">
							<i class="fa fa-download"></i> [[user:consent.export_posts]]
						</a>
						<a rel="nofollow" class="btn btn-default" href="{config.relative_path}/api/user/uid/{userslug}/export/uploads">
