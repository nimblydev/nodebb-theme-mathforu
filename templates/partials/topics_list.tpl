		...
		<div class="col-md-6 col-sm-9 col-xs-10 content">
			...
			<h2 component="topic/header" class="title">
				...
				<span class="tag-list hidden-xs">
					{{{each topics.tags}}}
					<a rel="nofollow" href="{config.relative_path}/tags/{topics.tags.value}"><span class="tag" style="<!-- IF topics.tags.color -->color: {topics.tags.color};<!-- ENDIF topics.tags.color --><!-- IF topics.tags.bgColor -->background-color: {topics.tags.bgColor};<!-- ENDIF topics.tags.bgColor -->">{topics.tags.valueEscaped}</span></a>
					{{{end}}}
					<small>&bull;</small>
				</span>
